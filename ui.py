...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.false_btn = tkinter.Button(image=self.false_img, highlightthickness=0, command=self.false_pressed)
        self.false_btn.grid(column=1, row=2)

        self.true_img = PhotoImage(file='images/true.png')
        self.true_btn = tkinter.Button(image=self.true_img, highlightthickness=0, command=self.true_pressed)
